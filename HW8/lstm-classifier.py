...
class TextClassifier(nn.Module):
    def __init__(self, vocab_size, embed_size, hidden_size, num_classes, dropout_rate, vocab):
        super(TextClassifier, self).__init__()
        self.vocab = vocab
        self.embedding = nn.Embedding(vocab_size, embed_size, padding_idx=self.vocab['<pad>'])
    ...
    def forward(self, text, text_lengths):
        ...
        output, _ = pad_packed_sequence(packed_output, batch_first=True, padding_value=self.vocab['<pad>'])
...
def main():
    ...
    parser.add_argument('parfile', type=str, help="Path to the parfile1")
    ...
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, collate_fn=lambda batch: collate(batch, vocab))
    dev_loader = DataLoader(dev_dataset, batch_size=args.batch_size, shuffle=False, collate_fn=lambda batch: collate(batch, vocab))

    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

    model = TextClassifier(len(vocab), args.embed_size, args.hidden_size, LABEL_SIZE, args.dropout, vocab).to(device)
    ...
    model.save_params(args.parfile)
...
"""
python lstm-classifier.py data/sentiment.train.tsv data/sentiment.dev.tsv parfile1 --embed_size 512 --epochs 15 --batch_size 32 --lr 0.002
Epoch 1: Train Loss = 1.5873, Train Accuracy =  0.2815, Dev Loss = 1.5307, Dev Accuracy = 0.3161
Epoch 2: Train Loss = 1.4983, Train Accuracy =  0.3343, Dev Loss = 1.4677, Dev Accuracy = 0.3624
Epoch 3: Train Loss = 1.3785, Train Accuracy =  0.3956, Dev Loss = 1.4638, Dev Accuracy = 0.3787
Epoch 4: Train Loss = 1.2803, Train Accuracy =  0.4280, Dev Loss = 1.4556, Dev Accuracy = 0.3833
Epoch 5: Train Loss = 1.2009, Train Accuracy =  0.4782, Dev Loss = 1.5322, Dev Accuracy = 0.3833
Epoch 6: Train Loss = 1.1232, Train Accuracy =  0.5180, Dev Loss = 1.6235, Dev Accuracy = 0.3887
Epoch 7: Train Loss = 1.0752, Train Accuracy =  0.5330, Dev Loss = 1.6714, Dev Accuracy = 0.3978
Epoch 8: Train Loss = 1.0246, Train Accuracy =  0.5633, Dev Loss = 1.7054, Dev Accuracy = 0.3678
Epoch 9: Train Loss = 0.9872, Train Accuracy =  0.5882, Dev Loss = 1.8075, Dev Accuracy = 0.3806
Epoch 10: Train Loss = 0.9350, Train Accuracy =  0.6122, Dev Loss = 1.8725, Dev Accuracy = 0.3787
Epoch 11: Train Loss = 0.8921, Train Accuracy =  0.6447, Dev Loss = 1.9461, Dev Accuracy = 0.3815
Epoch 12: Train Loss = 0.8607, Train Accuracy =  0.6457, Dev Loss = 2.0546, Dev Accuracy = 0.3906
Epoch 13: Train Loss = 0.8315, Train Accuracy =  0.6614, Dev Loss = 2.1410, Dev Accuracy = 0.3906
Epoch 14: Train Loss = 0.7958, Train Accuracy =  0.6818, Dev Loss = 2.1344, Dev Accuracy = 0.3842
Epoch 15: Train Loss = 0.7799, Train Accuracy =  0.6869, Dev Loss = 2.2518, Dev Accuracy = 0.3715
"""